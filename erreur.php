		...
		<section id="content">
			<div class="content-wrap content-all">
				<div class="content-wrap">
					<div class="container clearfix">
					<p class="text-center"><i class="fas fa-8x fa-tools"></i><p>
						<h2 class="text-center">Erreur <?= htmlspecialchars($_GET['erreur']) ?></h2>
						<h4 class="text-center">La page est introuvable</h4>
					</div>
				</div>
			</div>
		</section>
