...
if($maintenance==1 && !isset($_GET['content'])){
?>
<!DOCTYPE html>
		...
		<section id="content">
			<div class="content-wrap content-all">
				<div class="content-wrap">
					<div class="container clearfix">
						<h2 class="text-center comingsoon">COMING SOON</h2>
						<p class="text-center comingsoon">Cette page est en cours de construction.</p>
					</div>
				</div>
			</div>
		</section>
